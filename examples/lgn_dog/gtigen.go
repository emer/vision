...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"OutTsr", &gti.Field{Name: "OutTsr", Type: "goki.dev/etable/v2/etensor.Float32", LocalType: "etensor.Float32", Doc: "DoG filter output tensor", Directives: gti.Directives{}, Tag: "view:\"no-inline\""}},
	}),
